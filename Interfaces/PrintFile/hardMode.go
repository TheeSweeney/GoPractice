...
the file to open should be provided as an argument to the program when it is executred at the terminal. For example 'go run main.go myfile.txt' should open up the myfile.txt file
